...
export function runSummarizeRun(options, { requireOption, ensureStateForRun, appendRunStartIfMissing, appendRunEndIfMissing }) {
  ...
  const renderText = () => {
    ...
    return [
      ...
      ...(summary.total_wall_clock_s !== undefined ? [`wall_clock_s: ${summary.total_wall_clock_s}`] : []),
  ...
  const renderMarkdown = () => {
    ...
    return [
      ...
      ...(summary.total_wall_clock_s !== undefined ? [`- Wall clock (s): \`${summary.total_wall_clock_s}\``] : []),
